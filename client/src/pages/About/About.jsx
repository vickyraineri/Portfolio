...
export const About = () => {
    return (
        <div class="mt-32 mx-16 mb-12 flex flex-col items-center select-none">
            ...
            <div class="self-center w-auto mt-16 md:mt-10 border-2 border-x-purple-600 border-y-fuchsia-500 shadow-md shadow-fuchsia-500/50 p-10 md:p-24 py-14 rounded-3xl justify-center bg-black/50 mb-16">
